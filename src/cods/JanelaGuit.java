...
public class JanelaGuit extends javax.swing.JFrame {
    ...
    static pgGuit bancoGuit = new pgGuit();
    ...
    public void alterar(){
        ...
        guit.setCodigo(txtCodigo.getText());
        String CodAnt = guit.getCodigo();
        
        guit = gerGuit.alteraGuit(guit, CodAnt);
        bancoGuit.updateGuit(guit, CodAnt);
    ...
    public static void listarTab(){
        ...
        for(Guitarra guit : bancoGuit.queryGuit()){
